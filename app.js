...
const APP_BUILD_TIME = '2026-08-17 16:55';
...
function ensureDirectQuotationDialog() {
  if (!document.querySelector('[data-nav-action="directQuotationNew"]')) {
    const pricingButton = document.querySelector('[data-nav-action="pricingNew"]');
    pricingButton?.insertAdjacentHTML('afterend', '<button type="button" data-module-action="pricing" data-nav-action="directQuotationNew">عرض سعر مباشر</button>');
  }

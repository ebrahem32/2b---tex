...
const DYEHOUSE_PRICE_LIBRARY = {
  'نص قديم غير مستعاد نص قديم غير مستعاد': {
    effectiveFrom: '2026-04-02',
    dyeing: {
      'نص قديم غير مستعاد': { 'نص قديم غير مستعاد':36, 'نص قديم غير مستعاد نص قديم غير مستعاد':null, 'نص قديم غير مستعاد نص قديم غير مستعاد':null, 'نص قديم غير مستعاد':39, 'نص قديم غير مستعاد':43, 'نص قديم غير مستعاد':46, 'نص قديم غير مستعاد':48, 'نص قديم غير مستعاد':51, 'نص قديم غير مستعاد نص قديم غير مستعاد':null },
      'نص قديم غير مستعاد': { 'نص قديم غير مستعاد':40, 'نص قديم غير مستعاد نص قديم غير مستعاد':47, 'نص قديم غير مستعاد نص قديم غير مستعاد':47, 'نص قديم غير مستعاد':52, 'نص قديم غير مستعاد':65, 'نص قديم غير مستعاد':67, 'نص قديم غير مستعاد':70, 'نص قديم غير مستعاد':72, 'نص قديم غير مستعاد نص قديم غير مستعاد':78 },
      'نص قديم غير مستعاد': { 'نص قديم غير مستعاد':40, 'نص قديم غير مستعاد نص قديم غير مستعاد':47, 'نص قديم غير مستعاد نص قديم غير مستعاد':47, 'نص قديم غير مستعاد':52, 'نص قديم غير مستعاد':60, 'نص قديم غير مستعاد':63, 'نص قديم غير مستعاد':65, 'نص قديم غير مستعاد':67, 'نص قديم غير مستعاد نص قديم غير مستعاد':72 },
      'نص قديم غير مستعاد': { 'نص قديم غير مستعاد':40, 'نص قديم غير مستعاد نص قديم غير مستعاد':47, 'نص قديم غير مستعاد نص قديم غير مستعاد':47, 'نص قديم غير مستعاد':52, 'نص قديم غير مستعاد':75, 'نص قديم غير مستعاد':77, 'نص قديم غير مستعاد':79, 'نص قديم غير مستعاد':82, 'نص قديم غير مستعاد نص قديم غير مستعاد':87 },
    },
    extras: { 'نص قديم غير مستعاد':7, 'نص قديم غير مستعاد نص قديم غير مستعاد':9, 'نص قديم غير مستعاد نص قديم غير مستعاد':7, 'نص قديم غير مستعاد نص قديم غير مستعاد':10, 'نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد':7, 'نص قديم غير مستعاد نص قديم غير مستعاد':9, 'نص قديم غير مستعاد نص قديم غير مستعاد':9, 'نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد':5, 'نص قديم غير مستعاد نص قديم غير مستعاد':6, 'نص قديم غير مستعاد':9, 'نص قديم غير مستعاد':8, 'نص قديم غير مستعاد':8, 'نص قديم غير مستعاد':9 },
  },
  'نص قديم غير مستعاد': {
    effectiveFrom: '2026-04-15',
    dyeing: {
      'نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد': { 'نص قديم غير مستعاد':60, 'نص قديم غير مستعاد':70, 'نص قديم غير مستعاد':77, 'نص قديم غير مستعاد':75, 'نص قديم غير مستعاد':80 },
      'نص قديم غير مستعاد نص قديم غير مستعاد': { 'نص قديم غير مستعاد':67, 'نص قديم غير مستعاد':77, 'نص قديم غير مستعاد':84, 'نص قديم غير مستعاد':82, 'نص قديم غير مستعاد':87 },
    },
    extras: { 'نص قديم غير مستعاد نص قديم غير مستعاد':53, 'نص قديم غير مستعاد + نص قديم غير مستعاد نص قديم غير مستعاد':53, 'نص قديم غير مستعاد':16, 'نص قديم غير مستعاد':13, 'نص قديم غير مستعاد':14, 'نص قديم غير مستعاد':5, 'نص قديم غير مستعاد نص قديم غير مستعاد':5, 'نص قديم غير مستعاد':4, 'نص قديم غير مستعاد':5, 'نص قديم غير مستعاد نص قديم غير مستعاد':5 },
  },
  'نص قديم غير مستعاد نص قديم غير مستعاد': {
    effectiveFrom: '2026-04-15',
    aliasOf: 'نص قديم غير مستعاد',
  },
  'نص قديم غير مستعاد': {
    effectiveFrom: '',
    dyeing: {},
  ...
  'نص قديم غير مستعاد': {
    effectiveFrom: '',
    dyeing: {
      'نص قديم غير مستعاد': { 'نص قديم غير مستعاد':33, 'نص قديم غير مستعاد نص قديم غير مستعاد':40, 'نص قديم غير مستعاد':40, 'نص قديم غير مستعاد':53, 'نص قديم غير مستعاد':55.25, 'نص قديم غير مستعاد':63, 'نص قديم غير مستعاد':69, 'نص قديم غير مستعاد':78, 'نص قديم غير مستعاد':78 },
      'نص قديم غير مستعاد 100%': { 'نص قديم غير مستعاد':33, 'نص قديم غير مستعاد':33, 'نص قديم غير مستعاد':34, 'نص قديم غير مستعاد':40, 'نص قديم غير مستعاد':null, 'نص قديم غير مستعاد نص قديم غير مستعاد':36, 'نص قديم غير مستعاد نص قديم غير مستعاد':37, 'نص قديم غير مستعاد نص قديم غير مستعاد':43 },
    },
    notes: ['نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد 5 نص قديم غير مستعاد', 'نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد'],
  },
  'نص قديم غير مستعاد نص قديم غير مستعاد': {
    effectiveFrom: '',
    dyeing: {
      'نص قديم غير مستعاد': { 'نص قديم غير مستعاد':44, 'نص قديم غير مستعاد':38, 'نص قديم غير مستعاد':36, 'نص قديم غير مستعاد':33, 'نص قديم غير مستعاد':27, 'نص قديم غير مستعاد':25 },
      'نص قديم غير مستعاد': { 'نص قديم غير مستعاد':60, 'نص قديم غير مستعاد':56, 'نص قديم غير مستعاد':52, 'نص قديم غير مستعاد':38, 'نص قديم غير مستعاد':35 },
      'نص قديم غير مستعاد': { 'نص قديم غير مستعاد':67, 'نص قديم غير مستعاد':65, 'نص قديم غير مستعاد':60, 'نص قديم غير مستعاد':57, 'نص قديم غير مستعاد':42, 'نص قديم غير مستعاد':38 },
      'نص قديم غير مستعاد': { 'نص قديم غير مستعاد':65, 'نص قديم غير مستعاد':61, 'نص قديم غير مستعاد':58, 'نص قديم غير مستعاد':54, 'نص قديم غير مستعاد':42, 'نص قديم غير مستعاد':38 },
    },
...
function applyPricingDyehouseOptions() {
  ...
  const names = Object.keys(activeDyehousePriceLibrary())
    .filter((name)=>name && !String(name).includes(['نص','قديم','غير','مستعاد'].join(' ')))
...
const FINISHING_PRICE_LIBRARY = {
  general: {
    'نص قديم غير مستعاد نص قديم غير مستعاد + نص قديم غير مستعاد':7.5,
    'نص قديم غير مستعاد نص قديم غير مستعاد':4,
    'نص قديم غير مستعاد + نص قديم غير مستعاد نص قديم غير مستعاد':3,
    'نص قديم غير مستعاد':5.5,
    'نص قديم غير مستعاد نص قديم غير مستعاد':7,
    'نص قديم غير مستعاد نص قديم غير مستعاد':5,
    'نص قديم غير مستعاد':5,
    'نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد':6,
    'نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد':8.5,
    'نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد':7.5,
    'نص قديم غير مستعاد نص قديم غير مستعاد':5,
    'نص قديم غير مستعاد نص قديم غير مستعاد':4,
    'نص قديم غير مستعاد نص قديم غير مستعاد':7.5,
    'نص قديم غير مستعاد نص قديم غير مستعاد':7,
    'نص قديم غير مستعاد نص قديم غير مستعاد':5.5,
    'نص قديم غير مستعاد نص قديم غير مستعاد':3,
    'نص قديم غير مستعاد':50,
  },
};
...
function addPricing(event) {
  ...
  if (editingPricingId) {
    ...
    if (index !== -1) { const before = clone(pricings[index]); pricings[index] = pricingPayload(editingPricingId); recordAudit('update', 'pricing', editingPricingId, before, pricings[index], `تعديل التسعيرة رقم ${pricings[index].pricingNumber || ''}`); }
    editingPricingId = null;
  } else {
    const createdPricing = pricingPayload(); pricings.unshift(createdPricing); recordAudit('create', 'pricing', createdPricing.id, null, createdPricing, `إنشاء التسعيرة رقم ${createdPricing.pricingNumber || ''}`);
  }
...
async function markPricingConverted(pricingNumber, orderId, pricingId = null) {
  ...
  for (const pricing of converted) {
    await putBackend(`/pricings/${pricing.id}`, { status:'converted', notes:pricing.notes || '' });
  }
}
...
function renderDetails() {
  ...
  const rawItems = (()=>{ const outgoing = rawBatches.filter((batch)=>batch.orderId===order.id).map((batch)=>{ const widthLine = order.widthLines.find((item)=>item.id===batch.widthLineId); const widthLabel = widthLine ? ` / بوصة ${widthLine.inch} - عرض ${widthLine.width}` : ''; return { type:'raw', batch, label:`خروج خام ${batch.date} ? ${batch.quantity} / ${batch.supplier || '-'}${widthLabel}` }; }); const returns = rawReturns.filter((batch)=>order.allocations.some((allocation)=>allocation.id===batch.allocationId)).map((batch)=>{ const allocation=order.allocations.find((item)=>item.id===batch.allocationId); return { type:'rawReturn', batch, label:`خروج خام ${batch.date} ? ${allocation?.dyehouse || '-'} ? ${allocation?.color || '-'} ? ${batch.quantity}${batch.noteNumber ? ' / رقم إذن ' + batch.noteNumber : ''}` }; }); const rows = outgoing.concat(returns).sort((a,b)=>String(b.batch.date||'').localeCompare(String(a.batch.date||''))); return rows.length ? rows.map((item)=>batchItemHtml(item.type, item.batch, item.label)).join('') : '<div class="empty-state">لا توجد دفعات بعد.</div>'; })();
  ...
  const accessoryItems = listHtml(accessoryBatches.filter((batch)=>batch.orderId===order.id && batch.movement === 'sent'), (batch)=>batchItemHtml('accessory', batch, `${batch.date} ? ${batch.quantity} / ${batch.accessoryType || order.accessoryLines[0]?.type || 'ملاحظة'}${batch.noteNumber ? ' / رقم إذن ' + batch.noteNumber : ''}`));
  const accessoryReceivedItems = listHtml(accessoryBatches.filter((batch)=>batch.orderId===order.id && batch.movement === 'received'), (batch)=>batchItemHtml('accessory', batch, `${batch.date} ? ${accessoryColor(batch)} ? ${batch.quantity} / ${batch.accessoryType}`));
  const productionItems = listHtml(productionBatches.filter((batch)=>order.allocations.some((allocation)=>allocation.id===batch.allocationId)), (batch)=>{ const allocation=order.allocations.find((item)=>item.id===batch.allocationId); return batchItemHtml('production', batch, `${batch.date} ? ${allocation?.dyehouse || '-'} ? ${allocation?.color || '-'} ? ${batch.quantity}${batch.noteNumber ? ' / رقم إذن ' + batch.noteNumber : ''}`); });
  const customerItems = (()=>{ const cloth = customerBatches.filter((batch)=>order.allocations.some((allocation)=>allocation.id===batch.allocationId)).map((batch)=>{ const allocation=order.allocations.find((item)=>item.id===batch.allocationId); const label = allocation ? allocationColorLabel(order, allocation) : '-'; return { type:'customer', batch, label:`خروج خام ${batch.date} ? ${label} ? ${batch.quantity}` }; }); const accessories = accessoryBatches.filter((batch)=>batch.orderId===order.id && batch.movement === 'customer').map((batch)=>{ const allocation=order.allocations.find((item)=>item.id===batch.allocationId); const label = allocation ? allocationColorLabel(order, allocation) : accessoryColor(batch); return { type:'accessory', batch, label:`خروج خام ${batch.date} ? ${label} ? ${batch.quantity} / ${batch.accessoryType || order.accessoryLines[0]?.type || 'ملاحظة'}` }; }); const rows = cloth.concat(accessories).sort((a,b)=>String(b.batch.date||'').localeCompare(String(a.batch.date||''))); return rows.length ? rows.map((item)=>batchItemHtml(item.type, item.batch, item.label)).join('') : '<div class="empty-state">لا توجد دفعات بعد.</div>'; })();
  const transferItems = listHtml(dyehouseTransfers.filter((batch)=>batch.orderId===order.id), (batch)=>batchItemHtml('transfer', batch, `${batch.date} ? ${batch.color || '-'} ? ${batch.fromDyehouse || '-'} ? ${batch.toDyehouse || '-'} ? ${batch.quantity}${batch.noteNumber ? ' / رقم إذن ' + batch.noteNumber : ''}`));
  const rawReturnItems = listHtml(rawReturns.filter((batch)=>order.allocations.some((allocation)=>allocation.id===batch.allocationId)), (batch)=>{ const allocation=order.allocations.find((item)=>item.id===batch.allocationId); return batchItemHtml('rawReturn', batch, `${batch.date} ? ${allocation?.dyehouse || '-'} ? ${allocation?.color || '-'} ? ${batch.quantity}${batch.noteNumber ? ' / رقم إذن ' + batch.noteNumber : ''}`); });
...
async function addBatch(event) {
  ...
  if (type === 'raw') { const currentOrder = calculateOrder(orders.find((item)=>item.id===selectedOrderId)); data.orderId = selectedOrderId; if (data.movementKind === 'return') { if (!data.allocationId) { alert('اختر اللون / المصبغة قبل تسجيل مرتجع الخام.'); return; } rawReturns.unshift(data); } else { if (currentOrder.widthMode === 'multiple' && !data.widthLineId) { alert('اختر العرض المرتبط قبل تسجيل خروج الخام.'); return; } if (rawDocumentFile) data.sourceDocument = { type:'raw-batch-image', image: await resizeSlipImage(rawDocumentFile) }; rawBatches.unshift(data); await postBackend('/batches/dyehouse', batchToApi(data)); } }
  if (type === 'rawReturn') { if (!data.allocationId) { alert('اختر اللون / المصبغة قبل تسجيل مرتجع الخام.'); return; } data.orderId = selectedOrderId; rawReturns.unshift(data); }
  if (type === 'accessory') { if (!data.accessoryType) { alert('اختر نوع الإكسسوار أولًا.'); return; } data.orderId = selectedOrderId; data.movement = 'sent'; delete data.allocationId; accessoryBatches.unshift(data); await postBackend('/batches/accessory', batchToApi(data)); }
  if (type === 'accessoryReceived') { if (!data.accessoryType) { alert('اختر نوع الإكسسوار أولًا.'); return; } if (!data.allocationId) { alert('اختر اللون المرتبط باستلام الإكسسوار.'); return; } data.orderId = selectedOrderId; data.movement = 'received'; accessoryBatches.unshift(data); await postBackend('/batches/accessory', batchToApi(data)); }
  if (type === 'production') {
    ...
    await postBackend('/batches/finished', batchToApi(data));
  }
  if (type === 'finished') {
  ...
  if (type === 'customer') {
    if (data.movementKind === 'accessory') {
      ...
      await postBackend('/batches/accessory', batchToApi(data));
    } else {
      const allocation = calculateAllocation(allocations.find((item)=>item.id===data.allocationId));
      ...
      await postBackend('/batches/customer', batchToApi(data));
    }
  }
  save(); renderAll();
}
async function addAllocation() {
  ...
  for (const allocation of createdAllocations) await postBackend(`/orders/${order.id}/allocations`, allocationToApi(allocation));
  save(); renderAll();
}
function editAllocation(id) {
  ...
  const colorValue = prompt('نص قديم غير مستعاد / نص قديم غير مستعاد نص قديم غير مستعاد', allocation.color || allocation.pantoneCode || '');
  if (colorValue === null) return;
  const cleanedColor = colorValue.trim();
  if (!cleanedColor) return;
  const targetFinishedWidth = Number(prompt('نص قديم غير مستعاد نص قديم غير مستعاد', allocation.targetFinishedWidth));
  if (!targetFinishedWidth) return;
  const targetFinishedWeight = Number(prompt('نص قديم غير مستعاد نص قديم غير مستعاد', allocation.targetFinishedWeight));
...
function deleteAllocation(id) {
  ...
  dyehouseTransfers = dyehouseTransfers.filter((batch)=>batch.allocationId!==id);
  save();
  renderAll();
}
...
function deleteBatch(type, id) {
  if (!confirm('نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد. نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعادɿ')) return;
  if (type === 'transfer') {
    const transfer = dyehouseTransfers.find((batch)=>String(batch.id) === String(id));
    if (transfer) {
      if (transfer.mode === 'split' && transfer.newAllocationId) {
        ...
        if (newAllocation && originalAllocation && !hasLinkedMovements) {
          ...
          alert('نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعادء نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد. نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد.');
        }
...
function editBatch(type, id) {
  ...
  const quantity = Number(prompt('نص قديم غير مستعاد', batch.quantity)); if (!quantity) return; batch.quantity = quantity;
  batch.date = prompt('نص قديم غير مستعاد', batch.date) || batch.date;
  if (type === 'raw') { batch.supplier = prompt('نص قديم غير مستعاد نص قديم غير مستعاد', batch.supplier) || batch.supplier; batch.noteNumber = prompt('نص قديم غير مستعاد نص قديم غير مستعاد', batch.noteNumber || '') || ''; batch.notes = prompt('نص قديم غير مستعاد', batch.notes || '') || ''; }
  ...
  if (type === 'rawReturn') { batch.noteNumber = prompt('نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد', batch.noteNumber || '') || ''; batch.notes = prompt('نص قديم غير مستعاد', batch.notes || '') || ''; }
  if (type === 'accessory') { batch.accessoryType = prompt('نص قديم غير مستعاد نص قديم غير مستعاد', batch.accessoryType) || batch.accessoryType; batch.noteNumber = prompt('نص قديم غير مستعاد نص قديم غير مستعاد', batch.noteNumber || '') || ''; batch.notes = prompt('نص قديم غير مستعاد', batch.notes || '') || ''; }
  if (type === 'dye') { batch.noteNumber = prompt('نص قديم غير مستعاد نص قديم غير مستعاد', batch.noteNumber || '') || ''; batch.notes = prompt('نص قديم غير مستعاد', batch.notes || '') || ''; }
  if (type === 'production') { batch.noteNumber = prompt('نص قديم غير مستعاد نص قديم غير مستعاد نص قديم غير مستعاد', batch.noteNumber || '') || ''; batch.notes = prompt('نص قديم غير مستعاد', batch.notes || '') || ''; }
  if (type === 'finished') { batch.finishedWidth = Number(prompt('نص قديم غير مستعاد نص قديم غير مستعاد', batch.finishedWidth)); batch.finishedWeight = Number(prompt('نص قديم غير مستعاد نص قديم غير مستعاد', batch.finishedWeight)); batch.notes = prompt('نص قديم غير مستعاد', batch.notes || '') || ''; }
  save(); renderAll();
}
...
function openManagementReport(type) {
  ...
  if (type === 'order-movement') {
    ...
    return showManagementReport('حركة الطلبات', 'تواريخ انتقال الطلبات بين مراحل التشغيل.', `<section class="report-section"><h3>تواريخ الحركة</h3><table class="follow-table"><thead><tr><th>رقم الطلب</th><th>العميل</th><th>الصنف</th><th>تاريخ الطلب</th><th>استلام الخام</th><th>دخول المخزن</th><th>تسليم العميل</th><th>مرحلة التشغيل</th></tr></thead><tbody>${rows || '<tr><td colspan="8">لا توجد حركات طلبات.</td></tr>'}</tbody></table></section>`, type);
  }
  if (type === 'raw-returns') {
...
function openDyeingDocumentForDyehouse(dyehouseName) {
  ...
  const name = String(dyehouseName || '').trim();
  const rawNoteNumbers = [...new Set(rawBatches.filter((batch)=>batch.orderId===order.id).map((batch)=>batch.noteNumber).filter(Boolean))].join('، ') || '-';
  const dyeingMeta = `<div class="document-meta"><div><span>رقم الطلب</span>${order.orderNumber}</div><div><span>التاريخ</span>${order.orderDate}</div><div><span>الصنف</span>${order.fabricType || '-'}</div><div><span>أذون صرف الخام</span>${rawNoteNumbers}</div></div>`;
  const fmt = (value) => roundNumber(value).toLocaleString('ar-EG', { maximumFractionDigits: 3 });
  ...
  refs.documentBody.innerHTML = `<div class="document-sheet dyeing-document">${withDocumentFooter(buildDyeingOrderReport(reportOrder, name, dyeingMeta, fmt))}</div>`;
  if (refs.documentDialog.open) refs.documentDialog.close();
  refs.documentDialog.showModal();
...
function openDocument(type) {
  ...
  if (type === 'quotation') {
    ...
    body = `${documentHeader()}<div class="report-title"><h2>أمر تشغيل نسيج</h2><span>أمر تشغيل الخام قبل الصباغة.</span></div>${infoCards}<section class="report-section"><h3>بيانات الخام</h3><table class="summary-table"><tbody><tr><th>إجمالي الخام المطلوب</th><td>${fmt(order.totalRawOrdered)}</td><th>سعر الخام</th><td>${fmt(orderRawCost(order))}</td></tr><tr><th>مصدر النسيج</th><td>${safe(order.weavingSource)}</td><th>البوصة</th><td>${safe(order.inchWidth)}</td></tr></tbody></table></section>${accessorySection}${allocationTable}${notes}${documentFooter()}`;
  } else if (type === 'dyeing') {
    const rawNotes = getFirstRawNoteNumber(order) || '-';
    body = `${documentHeader()}<div class="report-title"><h2>أمر تشغيل صباغة</h2><span>أمر تشغيل الصباغة للمصبغة المحددة.</span></div>${infoCards}<section class="report-section"><h3>بيانات الصباغة</h3><table class="summary-table"><tbody><tr><th>إذن الخام</th><td>${safe(rawNotes)}</td><th>إجمالي كمية الصباغة</th><td>${fmt(order.totalSentToDyehouse || order.totalRawOrdered)}</td></tr><tr><th>عدد الألوان</th><td>${(order.allocations || []).length}</td><th>خام محول فعليًا</th><td>${fmt(order.totalSentToDyehouse)}</td></tr></tbody></table></section>${accessorySection}${allocationTable}${rawPermitImagesSection(order)}${notes}${documentFooter()}`;
  } else if (type === 'waste') {
    body = `${documentHeader()}<div class="report-title"><h2>تقرير الهالك</h2><span>الهالك الفعلي محسوب من التشغيل الفعلي وليس من المخطط.</span></div>${infoCards}<section class="report-section"><h3>تفاصيل الهالك</h3><table><thead><tr><th>اللون</th><th>مرسل للمصبغة</th><th>دخل المخزن</th><th>هالك تقديري</th><th>هالك فعلي</th><th>نسبة الهالك</th></tr></thead><tbody>${(order.allocations || []).map((line)=>`<tr><td>${safe(line.color || line.pantoneCode)}</td><td>${fmt(line.sentToDyehouse)}</td><td>${fmt(line.finishedReceived)}</td><td>${fmt(line.expectedWasteQuantity)}</td><td>${fmt(line.wasteQuantity)}</td><td>${formatNumber(line.wastePercent || 0, 1)}%</td></tr>`).join('') || '<tr><td colspan="6">لا توجد بيانات هالك.</td></tr>'}</tbody></table></section>${accessorySection}${documentFooter()}`;
  ...
  refs.documentBody.innerHTML = `<div class="document-sheet">${body}</div>`;
  if (type === 'labSamples' || type === 'stickers') refs.documentBody.innerHTML = body;
  if (refs.documentDialog.open) refs.documentDialog.close();
  refs.documentDialog.showModal();
}
...
function updateDocumentReviewFields() {
  ...
  refs.weavingSlipAllocation.innerHTML = `<option value="">اختر اللون / البند</option>${order.allocations.map((item)=>`<option value="${item.id}">${item.color} / عرض نهائي ${item.targetFinishedWidth} / كمية ${item.plannedQuantity}</option>`).join('')}`;
}
...
refs.orderForm.onsubmit = addOrder;
...
refs.ordersTableBody.onclick = (event) => {
  ...
  if (button.dataset.deleteOrder) deleteOrder(button.dataset.deleteOrder);
};
...
refs.orderDetailsPanel.addEventListener('click', (event) => {
  ...
  if (target.id === 'toggleOperationClosedBtn') { event.preventDefault(); toggleOperationClosed(); return; }
  if (target.id === 'addAllocationBtn') addAllocation();
  if (target.dataset.editAllocation) editAllocation(target.dataset.editAllocation);
  if (target.dataset.deleteAllocation) deleteAllocation(target.dataset.deleteAllocation);
  if (target.dataset.transferAllocation) transferAllocationDyehouse(target.dataset.transferAllocation);
  const action = target.dataset.batchAction;
  if (action === 'delete') deleteBatch(target.dataset.batchType, target.dataset.batchId);
  if (action === 'edit') editBatch(target.dataset.batchType, target.dataset.batchId);

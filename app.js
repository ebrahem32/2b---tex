...
const APP_VERSION = 'v2026.08.02.12';
const APP_BUILD_TIME = '2026-08-02 16:35';
...
function renderDetails() {
  ...
  const allocationPlanTable = refs.orderDetailsPanel.querySelector('#addAllocationBtn')?.closest('.subsection')?.querySelector('.allocation-table');

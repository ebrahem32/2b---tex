...
function checkPricingListFiltersAndOrderNumber() {
  ...
  assert(indexSource.includes('./modules/navigation.js?v=20260817-03'), 'pricing navigation: navigation asset must use the current cache-busting key');
  assert(indexSource.includes('./app.js?v=20260817-03'), 'pricing navigation: main app asset must use the current cache-busting key');
